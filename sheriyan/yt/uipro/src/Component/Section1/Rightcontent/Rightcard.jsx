...
const Rightcard = () => {
  return (
    <div className="h-full  w-60 bg-red-600 relative overflow-hidden rounded-4xl">
      <img
      ...
      <div className="absolute top-0 left-0 h-full w-full p-6 flex flex-col justify-between">
        <h2 className="bg-white text-xl font-semibold flex justify-center items-center rounded-full h-10 w-10  ">1</h2>
        <div>
