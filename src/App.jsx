...
import { SiHtml5, SiCss3, SiJavascript, SiReact, SiTailwindcss, SiNodedotjs, SiExpress, SiMongodb, SiGit, SiGithub as SiGithubIcon, SiPostman, SiFigma, SiCanva, SiNetlify } from 'react-icons/si';
...
// YouTube Video Modal (in-portfolio)
    ...
    <AnimatePresence mode="wait">
      {isLoading ? (
        ...
        @media (hover: hover) and (pointer: fine) {
          ...
          .certificate-modal, .certificate-modal * { cursor: auto !important; }
          .video-modal-backdrop, .video-modal-backdrop * { cursor: auto !important; }
        }
        ...
        @media (hover: hover) and (pointer: fine) {
          .cursor-pointer, .cursor-circle { display: block; }
        }
        ...
        .skills-category-label:first-of-type { margin-top: 0; }
      ...
      `}</style>
          ...
          <motion.div
            ...
            animate={{ x: cursorPosition.x - 7, y: cursorPosition.y - 7 }}
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 2L20 12L12 14L8 22L4 2Z" fill="white"/>
            </svg>
          </motion.div>
                      ...
                      <div className="project-content">
                        ...
                        <div className="project-links">
                          ...
                          <button
                            ...
                            onClick={() => setVideoModalId(project.videoId)}
                            title="Watch Video"
                          >
                            <FiYoutube /> Video
                          </button>
